...
global.modules.push(new ConfigModuleClass("Auto Harp", "Extras", [new SettingToggle("Enabled", false), new SettingSlider("Tick Delay", 5, 0, 10)], ["Does the melody harp for you"]))
