...
global.modules.push(
  new ConfigModuleClass(
    "Profile Hider",
    "Render",
    [new SettingToggle("Enabled", false), new SettingToggle("Remove Scoreboard", true), new SettingToggle("Remove Player Stats", true), new SettingToggle("Remove Boss Bar", true)],
