...
global.modules.push(
  new ConfigModuleClass("Spin", "Render", [new SettingToggle("Enabled", false), new SettingSlider("Speed", 10, 0, 20), new SettingSelector("Mode", 0, ["Left", "Right", "Pitch", "Seizure"])], ["Spins the player client side"]),
)
