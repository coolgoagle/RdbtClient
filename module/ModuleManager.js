...
class ModuleManagerClass {
  ...
  makeObject() {
    const file = FileLib.read("RdbtConfigV4", "rdbtconfig.json")
    ...
    FileLib.write("RdbtConfigV4", "rdbtconfig.json", stringJSON)
  ...
  saveSettings() {
    let file = FileLib.read("RdbtConfigV4", "rdbtconfig.json")
