let { TimeHelper, ChatUtils, NotificationUtils, ResponseBot, Utils, overlayManager, SmartFailsafe } = global.export
  ...
  constructor() {
    ...
    register("command", () => {
      ...
      if (this._testFailsafesEnabled) {
        ChatUtils.sendCustomMessage("AutoVegetable", "&aFailsafes Enabled!")
        this.register(
          cb => {
            this.postAction()
            overlayManager.DisableOverlay(this.OVERLAY_ID)
        ...
        ChatUtils.sendCustomMessage("AutoVegetable", "&cFailsafes Disabled!")
        this.unregister()
      }
