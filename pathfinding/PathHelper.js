let { TimeHelper, MathUtils, ChatUtils, Utils, Vector, RdbtPathFinder, Rotations, MovementHelper } = global.export
...
class PathHelper {
  constructor() {
    ...
    register("tick", () => {
      ...
      if (RdbtPathFinder.currentNode && MathUtils.getDistanceToPlayer(this.target).distanceFlat > 1.5) {
